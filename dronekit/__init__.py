...
class Hangar():
    ...
    """
    def __init__(self, esp_ip='192.168.1.21', img_url='https://openapi.icloseli.com/rest/service/camera/xxxxS_000c43b93fdb/thumbnail/current?size=1920x1080&token=5001423dc99544fc839c88f7f0bd86c8'):
    ...
    def _show_img(self):
        ...
        while not KeyboardInterrupt:
            ...
            # The final image size can be changed in the line below
